...
define("DATABASE_NAME", "samudra"); //nama database
define("DATABASE_USER", "root"); //user database 
define("DATABASE_PASSWORD", ""); // password 
//connect it!
mysql_connect(DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD) or die("<p>Koneksi Gagal! ccek konfigurasi koneksi:<br />" .mysql_error(). "</p>");
